...
public class IWander : MonoBehaviour, IState
{
    ...
    private int environmentLayer = 1 << 8;
    ...
    /// </summary> 
    private void Move() =>
        entity.rb.velocity = entity.facingDirection.transform.up * entity.speed * Time.deltaTime * 80;
    ...
    private bool Walkable()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(entity.facingDirection.transform.position,
            entity.facingDirection.transform.up, 2 , environmentLayer);
    ...
    private void AssignRandomRotation()
    {
        ...
        entity.waitTime = Random.Range(0f, 2f);
